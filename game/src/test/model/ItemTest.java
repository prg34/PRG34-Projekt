...
public class ItemTest {
    ...
    public void testUseWithItem() throws Exception {
        ...
        Item log = new Item("Holzscheit", "Ein stück leicht entzündbares, trockenes Holz.", 15, 15, "key.png", 250, 100, null, ash);
        Item match = new Item("Streichholz", "Ein perfektes Streichholz.", 15, 15, "key.png", 250, 100, log, ash);
