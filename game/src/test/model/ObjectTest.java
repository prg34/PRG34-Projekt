...
public class ObjectTest {
    ...
    public void testUseItemToOpen() throws Exception {
        ...
        Item key = new Item("Schlüssel", "Ein Schlüssel um etwas zu öffnen", 20, 20, "key.png", 250, 100, null, null);
        Object chest = new Object("Tür", 30, 30, "house.png", 250, 100, key, ring);
